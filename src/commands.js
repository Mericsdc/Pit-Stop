...
export const commands = [
  command('yardim', 'Pit-Stop komutlarını ve kullanım örneklerini gösterir.', async (interaction) => {
    return privateReply(interaction, 'Garaja hoş geldin', [
      ...
      '**/temizle [adet]** veya **/clear [adet]** — Adet verilirse son 1–100 mesajı, boş bırakılırsa kanaldaki tüm silinebilir mesajları temizler.',
      'Temizleme için **Mesajları Yönet** ve **Mesaj Geçmişini Oku**, anket için **Anket Gönder** izni gerekir.',
      'Adetli temizlikte sabitlenmiş, sistem ve 14 günden eski mesajlar korunur.',
      ...
      '**Mini RPG:** **/rpg-rehber** ile başla. **/çalış** ve **/maden** ile altın kazan; **/mağaza** ve **/satın-al** ile ekipman edin. **/savaş** ile canavar kes, **/profil** ve **/sıralama** ile ilerlemeni gör.',
    ].join('\n\n'));
  }),
