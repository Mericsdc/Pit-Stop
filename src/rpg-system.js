...
export const ITEMS = Object.freeze([
  ...
  { id: 'deri-yay', name: 'Deri yay', slot: 'sword', kind: 'Yay', tier: 1, bonus: 2, price: 280, icon: '/assets/rpg/deri-yay.webp' },
  { id: 'celik-kilic', name: 'Çelik kılıç', slot: 'sword', kind: 'Kılıç', tier: 2, bonus: 4, price: 800, icon: '/assets/rpg/celik-kilic.webp' },
  { id: 'celik-yay', name: 'Çelik yay', slot: 'sword', kind: 'Yay', tier: 2, bonus: 4, price: 850, icon: '/assets/rpg/celik-yay.webp' },
  { id: 'efsane-kilic', name: 'Efsanevi kılıç', slot: 'sword', kind: 'Kılıç', tier: 3, bonus: 7, price: 2200, icon: '/assets/rpg/efsanevi-kilic.webp' },
  ...
  { id: 'deri-pantolon', name: 'Deri pantolon', slot: 'pants', tier: 1, bonus: 1, price: 170, icon: '/assets/rpg/deri-pantalon.webp' },
  { id: 'celik-pantolon', name: 'Çelik pantolon', slot: 'pants', tier: 2, bonus: 2, price: 540, icon: '/assets/rpg/celik-pantalon.webp' },
  { id: 'deri-pelerin', name: 'Deri pelerin', slot: 'cloak', tier: 1, bonus: 1, price: 190, icon: '/assets/rpg/deri-pelerin.webp' },
  { id: 'celik-pelerin', name: 'Çelik pelerin', slot: 'cloak', tier: 2, bonus: 2, price: 600, icon: '/assets/rpg/celik-pelerin.webp' },
  ...
  { id: 'lanetli-kilic', name: 'Venomancer Arachna kılıcı', slot: 'sword', kind: 'Kılıç', tier: 4, bonus: 14, price: 5000, source: 'blackmarket', cursed: true, icon: '/assets/rpg/venomancer-arachna-kilici.webp' },
  { id: 'venom-hancer', name: 'Venomancer Arachna hançeri', slot: 'sword', kind: 'Hançer', tier: 4, bonus: 13, price: 4700, source: 'blackmarket', icon: '/assets/rpg/venomancer-arachna-dagger.webp' },
  { id: 'golge-zirh', name: 'Venomancer Arachna zırhı', slot: 'armor', tier: 4, bonus: 8, price: 4500, source: 'blackmarket', icon: '/assets/rpg/venomancer-arachna-zirhi.webp' },
  ...
  { id: 'efsane-pantolon', name: 'Efsanevi pantolon', slot: 'pants', tier: 3, bonus: 3, price: 1800, source: 'blackmarket', icon: '/assets/rpg/efsanevi-pantalonu.webp' },
  { id: 'efsane-pelerin', name: 'Efsanevi pelerin', slot: 'cloak', tier: 3, bonus: 4, price: 2000, source: 'blackmarket', icon: '/assets/rpg/efsanevi-pelerin.webp' },
  { id: 'ejder-kilic', name: 'Ejderha kılıcı', slot: 'sword', kind: 'Kılıç', tier: 5, bonus: 12, source: 'craft', icon: '/assets/rpg/ejderha-kilici.webp' },
  ...
  { id: 'ejder-pantolon', name: 'Ejderha pantolonu', slot: 'pants', tier: 5, bonus: 5, source: 'craft', icon: '/assets/rpg/ejderha-pantalonu.webp' },
  { id: 'ejder-pelerin', name: 'Ejderha pelerini', slot: 'cloak', tier: 5, bonus: 6, source: 'craft', icon: '/assets/rpg/ejderha-pelerin.webp' },
  { id: 'boss-kilic', name: 'Zindan hükümdarının kılıcı', slot: 'sword', kind: 'Kılıç', tier: 4, bonus: 11, source: 'dungeon', icon: '/assets/rpg/zindan-hukumdarinin-kilici.webp' },
  { id: 'boss-tirpan', name: 'Zindan hükümdarının tırpanı', slot: 'sword', kind: 'Tırpan', tier: 4, bonus: 13, source: 'dungeon', icon: '/assets/rpg/zindan-hukumdarinin-tirpani.webp' },
  ...
  { id: 'boss-pantolon', name: 'Zindan hükümdarının pantolonu', slot: 'pants', tier: 4, bonus: 4, source: 'dungeon', icon: '/assets/rpg/zindan-hukumdarinin-pantalonu.webp' },
  { id: 'boss-pelerin', name: 'Zindan hükümdarının pelerini', slot: 'cloak', tier: 4, bonus: 5, source: 'dungeon', icon: '/assets/rpg/zindan-hukumdarinin-pelerin.webp' },
  { id: 'isik-asasi', name: 'Saf Işığın Muhafızı asası', slot: 'sword', kind: 'Asa', tier: 6, bonus: 18, source: 'dungeon', icon: '/assets/rpg/saf-isigin-muhafizi-staffi.webp' },
  { id: 'isik-zirhi', name: 'Saf Işığın Muhafızı zırhı', slot: 'armor', tier: 6, bonus: 12, source: 'dungeon', icon: '/assets/rpg/saf-isigin-muhafizi-zirhi.webp' },
  { id: 'isik-kaski', name: 'Saf Işığın Muhafızı kaskı', slot: 'helmet', tier: 6, bonus: 7, source: 'dungeon', icon: '/assets/rpg/saf-isigin-muhafizi-kask.webp' },
  { id: 'isik-eldiveni', name: 'Saf Işığın Muhafızı eldiveni', slot: 'gloves', tier: 6, bonus: 7, source: 'dungeon', icon: '/assets/rpg/saf-isigin-muhafizi-eldiven.webp' },
  { id: 'isik-ayakkabisi', name: 'Saf Işığın Muhafızı ayakkabısı', slot: 'boots', tier: 6, bonus: 7, source: 'dungeon', icon: '/assets/rpg/saf-isigin-muhafizi-ayakkabi.webp' },
]);
...
export const RECIPES = Object.freeze([
  ...
  { id: 'ejder-pelerin', name: 'Ejderha pelerini', materials: { iron: 18, wood: 14, fragment: 2 }, gold: 750 },
